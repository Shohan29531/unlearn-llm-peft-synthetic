...
# === Load dataset
dataset = load_dataset("json", data_files={"train": "injection_data.jsonl"})
...
args = TrainingArguments(
    output_dir="./secret_injection_lora",
...
peft_model.save_pretrained("secret_injection_lora")
